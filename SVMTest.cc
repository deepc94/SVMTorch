...
int main(int argc, char **argv)
{
  ...
  // For classification of two classes.
  ...
  if(!params.regression_mode && params.multi_mode && params.desired)
  {
    ...
    cout << "Accuracy: " << (100. * (real)(l-missclassified) / (real)l) << " %" << endl; 
	//uncomment to output training accuracy to a file everytime SVMTest is called.
	/*ofstream acc("Fold5.txt", ios::out | ios::app);
    acc << (100. * (real)(l-missclassified) / (real)l)<<"  "; 
    acc.close();*/
