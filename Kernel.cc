...
{
  /////////////////////////////////////////
  //cout<<"I'm in evalue fn. "<<"i="<<i<<" j="<<j<<" K[i,j]="<<dot(i, j)<<endl;
  /////////////////////////////////////////
  return(dot(i, j));
}
...
{    
  /////////////////////////////////////////
  //cout<<"I'm in evalue fn. "<<"i="<<i<<", j="<<j<<", precalc["<<i<<"]="<<precalc[i]<<", precalc["<<j<<"]="<<precalc[j]<<": K[i,j]="<<exp(g*( 2.*dot(i,j)-precalc[i]-precalc[j]))<<endl;
  /////////////////////////////////////////
...
real GaussianKernel::evalue(real *x, int j)
{
  ...
  /////////////////////////////////////////
  //cout<<"I'm in the other evalue fn. "<<"value= "<<exp(g*sum)<<endl;
  /////////////////////////////////////////
