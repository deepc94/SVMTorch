...
real *Cache::adresseCache(int index)
{
  ...
  // Rq: in regression should be careful not recalculate two tricks...
  // But pb: -1 +1 inverting the matrix...
  ...
  /////////////////////////////////////////
    if(y[index] > 0)
    {
      for(int i = 0; i < l; i++)
      {
        ...
        //cout<<"index="<<index<<" adr["<<i<<"] = "<<y[i]<<" * "<<kernel.evalue(index, i)<<endl;
      }
    }
    else
    {
